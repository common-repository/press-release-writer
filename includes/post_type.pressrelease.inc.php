...
if(!defined("PRWIREPROWRITER_EXEC")){
	die();
}
...
class Pressrelease_TheContent{
	...
	public function __construct(){
		$this->options = get_option("press_release_writer_plugins"); // get current option
	...
	public function Markup($content){
		...
		$new_content .= "<div class=\"prwireprowriter-row\">" ; 
		$new_content .= "<div class=\"prwireprowriter-col-md-4\">" ; 
		$new_content .= "</div><!-- .//prwireprowriter-col-md-4 -->" ; 
		$new_content .= "<div class=\"prwireprowriter-col-md-8\">" ; 
		$new_content .= "<dl class=\"prwireprowriter-dl-horizontal\">" ; 
		$new_content .= "<dl>" ; 
		$new_content .= "</div><!-- .//prwireprowriter-col-md-8 -->" ; 
		$new_content .= "</div><!-- .//prwireprowriter-row -->" ; 
		...
		$new_content .= "<div class=\"prwireprowriter-panel prwireprowriter-panel-default\">" ;
		$new_content .= "<div class=\"prwireprowriter-panel-body\">" ;
		$new_content .= $content ;
		$new_content .= "</div>" ;
		$new_content .= "</div>" ;
		return $new_content;
